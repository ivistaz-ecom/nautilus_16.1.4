  ...
  return (
    <div className="p-3 sm:py-10 sm:px-4 h-full flex flex-col justify-center">
      ...
      <form className="flex flex-col gap-5 pt-6 sm:pt-7" onSubmit={handleForm}>
        ...
        {/* <div className="flex flex-col sm:flex-row justify-between items-end gap-4 sm:gap-10">{renderCountryField()}{renderStateField()}</div> */}
        {/* <div className="flex flex-col sm:flex-row justify-between items-end gap-4 sm:gap-10">{renderCityField()}{renderZipCodeField()}</div> */}
