export const incidents = [
  {
    ...
    sections: [
      {
        heading: "Description of Incident:",
        body: [
          "While carrying out routine rounds in the engine room, the wiper slipped due to unsecured floor plates. It was observed that the floor plates were not properly fastened with screws, creating a tripping and slipping hazard. Fortunately, no injury occurred.",
        ],
      },
      {
        ...
        points: [
          ...
          "The affected area was immediately cordoned off to prevent further movement.",
          "The loose floor plates were temporarily secured to avoid recurrence.",
        ],
      },
      {
        heading: "Potential Consequences:",
        points: [
          "Slip, trip, and fall injury to personnel.",
          "Serious injury caused by loss of balance on unsecured floor plates.",
          "Increased risk of accidents in a high-traffic engine room area.",
          "Damage to equipment or tools resulting from a fall.",
        ],
      },
      {
        heading: "Root Cause:",
  ...
  {
    id: 3,
    slug: "tangled-anchors-jaigarh-june-2024",
    ...
    sections: [
      {
        heading: "By Saif Alam",
        body: ["Rank: OS", "Vessel: JSW Lohgad"],
      },
      {
        heading: "Description of Event:",
        body: [
  ...
  {
    id: 4,
    slug: "unsafe-position-during-mooring-operations",
  ...
  {
    id: 5,
    slug: "why-every-tiny-detail-is-important",
